...
class ContinualDataset:
    ...
    @staticmethod
    @abstractmethod
    def get_arg_params(self) -> Namespace:
        """
        Returns the arg parameters to be used for to the current dataset.
        """
...
def store_masked_loaders_nota(train_dataset: datasets, test_dataset: datasets,
                    setting: ContinualDataset) -> Tuple[DataLoader, DataLoader]:
    """
    Divides the dataset into tasks.
    :param train_dataset: train dataset
