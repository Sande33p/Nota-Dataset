...
from datasets.seq_mnist_nota import SequentialMNIST_Nota
from datasets.seq_cifar10_nota import SequentialCIFAR10_Nota
...
NAMES = {
    ...
    SequentialMNIST_Nota.NAME: SequentialMNIST_Nota,
    SequentialCIFAR10_Nota.NAME: SequentialCIFAR10_Nota
}
